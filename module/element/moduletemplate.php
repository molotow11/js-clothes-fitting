...
class JFormFieldModuleTemplate extends JFormField {
	...
	function fetchElement($name, $value, &$node, $control_name) {
		...
		$moduleTemplatesPath = JPATH_SITE.DS.'modules'.DS.'mod_jshopping_clothes_fitting'.DS.'tmpl';
		...
		$templatePath = JPATH_SITE.DS.'templates'.DS.$defaultemplate.DS.'html'.DS.'mod_jshopping_clothes_fitting';
		...
		array_unshift($options, JHTML::_('select.option', 'Default', 'Default'));
