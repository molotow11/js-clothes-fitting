...
class JFormFieldFilters extends JFormField {	
	...
	function fetchElement($name, $value, &$node, $control_name) {
			...
			<script type='text/javascript'>
				...
				var FilterPath = '".JURI::root(true)."/modules/mod_jshopping_clothes_fitting/assets/';
				var MOD_JSHOP_EFILTER_ADMIN_SELECT_FIELD_TYPE = '".JText::_("MOD_JSHOP_EFILTER_ADMIN_SELECT_FIELD_TYPE")."';
				
				if(typeof jQuery == 'undefined') {
					var script = document.createElement('script');
					script.type = 'text/javascript';
					script.src = '".JURI::root(true)."/modules/mod_jshopping_clothes_fitting/assets/js/jquery-1.10.2.min.js';
