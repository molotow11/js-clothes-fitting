...
class modJShopExtendedFilterHelper {
	...
	function getCharValuesAuto($char_id, $restrict, $restcat, $restsub, $restmode) {
	...
	function getCharValuesByCat($char_id, $restrict, $restcat, $restsub, $restmode) {
	...
	function getAllManufacturers($restrict, $restcat, $restsub) {
		$db = JFactory::getDBO();
		$lang = JFactory::getLanguage();
		$lang_name = "name_".$lang->getTag();
	...
	function buildTreeCategory($restrict = 0, $restcat = "", $restsub = null) {
		$db = JFactory::getDBO();
		$lang = JFactory::getLanguage();
		$lang_name = "name_".$lang->getTag();
	...
	function getPriceValue($direction, $restrict, $restcat, $restsub, $restmode) {
		$db = JFactory::getDBO();
	...
	function getCharValue($direction, $char_id, $restrict, $restcat, $restsub, $restmode) {
